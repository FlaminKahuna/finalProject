...
bool readable = false; // Another safeguard variable, except this one is set over all the if statements just to make sure there is actually and input to make things happen
...
void Restart() {
 ...
 delay(50);
  ...
  CircuitPlayground.playTone(500,400);
